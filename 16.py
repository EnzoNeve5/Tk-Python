...
class Application(Funcs, Relatorios):
    ...
    def widgets_frame1(self):
        ...
        self.style.configure('BW.TButton', relwidth=1, relheight=1, foreground='gray', borderwidth=0, bordercolor='gray', background='#dfe3ee', image=self.imgNovo)
        ...
        self.imgAlterar = PhotoImage(file='botaoalterar.png')
        self.imgAlterar = self.imgAlterar.subsample(2, 2)
        self.style = ttk.Style()
        self.style.configure('BW.TButton', relwidth=1, relheight=1, foreground='gray', borderwidth=0, bordercolor='gray', background='#dfe3ee', image=self.imgAlterar)
        self.bt_alterar = ttk.Button(self.frame_1, style='BW.TButton', command=self.altera_cliente)
        self.bt_alterar.place(relx=0.73, rely=0.1, relwidth=0.13, relheight=0.15)
        self.bt_alterar.config(image=self.imgAlterar)

        self.imgApagar = PhotoImage(file='botaoapagar.png')
        self.imgApagar = self.imgApagar.subsample(2, 2)
        self.style = ttk.Style()
        self.style.configure('BW.TButton', relwidth=1, relheight=1, foreground='gray', borderwidth=0, bordercolor='gray', background='#dfe3ee', image=self.imgApagar)
