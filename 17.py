...
class Application(Funcs, Relatorios):
    ...
    def widgets_frame1(self):
        ...
        self.bt_alterar = Button(self.frame_1, bd=0, image=self.btAlterar, command=self.altera_cliente)
        ...
        self.bt_apagar = Button(self.frame_1, bd=0, image=self.btApagar, command=self.deleta_cliente)
